...
const Login = () => {
  return (
    <div className="flex items-center justify-center flex-col w-[600px] h-[580px] bg-[#8EB486] shadow-[0_4px_4px_rgba(0,0,0,0.25)] rounded-[44px]">
        ...
        <form className='flex flex-col items-center justify-center w-[90%] gap-5' action="post">
            ...
            <div className='w-full flex items-center justify-center pt-4 gap-6'>
                <button className="w-[60%] border-[3px] bg-transparent border-[#FFFFFF] rounded-full box-border">
                    <span className='font-jost text-[31px] leading-[40px] font-normal text-white'>
                        I don&apos;t have account
                    </span>
                </button>
                <button className="relative w-[40%] py-[11px] flex items-center justify-start bg-[#0FFFC3] border-[3px] border-[#FFFFFF] rounded-full box-border">
                    <span className='pl-3 font-jost text-[30px] leading-[40px] font-normal text-white'>Login</span>
        ...
        <div className='w-[78%] flex items-center text-center pt-5 pb-6'>
            <p className="font-inter text-[16px] leading-[24px] font-normal text-center text-[#FFF4EE] ">
                By clicking
                <span className='font-inter font-bold'> Log in </span> or <span className='font-inter font-bold'> Sign Up </span>, you agree to our <span className='font-inter underline'>Terms of use</span> and <span className='font-inter underline'>Privacy Policy</span>
            </p>
        </div>
