...
const DiscountPopup = () => {
  ...
  return (
    <div className='w-[500px] h-[730px] flex flex-col justify-center items-center gap-2 bg-[#D7FFCF] border-solid border-4 border-[#69C456] rounded-[40px] box-border'>
        <div className='flex flex-col justify-center items-center w-[78%] h-[85%] gap-6'>
            ...
            <span className='font-quicksand font-bold text-[28px] leading-[36px] text-center text-[#000000]'>Giá cũ: <span className='font-quicksand font-bold text-[28px] leading-[36px] text-center text-[#FF1601]'>{formatCurrency(item.oldPrice)} VND</span>
            </span>
            ...
            <span className='font-quicksand font-bold text-[28px] leading-[36px] text-center text-[#000000]'>Giá mới: <span className='font-quicksand font-bold text-[28px] leading-[36px] text-center text-[#352BFF]'>{formatCurrency(item.oldPrice*(1-item.discountPercent))} VND</span>
            </span>
        </div>
